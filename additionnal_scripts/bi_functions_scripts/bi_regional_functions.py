...
mapping_us_hazus_to_regional = (
    mean_factors / regional_factors["North America"]
)  # since we assume hazus is for North America and provides the link
