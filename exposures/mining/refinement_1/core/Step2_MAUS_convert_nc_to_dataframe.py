...
file = xr.open_dataset(
    f"{project_root}/exposures/mining/refinement_1/intermediate_data_MAUS/global_miningarea_v2_30arcsecond_converted.nc"
)  # high res
...
hdf_filename = f"{project_root}/exposures/mining/refinement_1/intermediate_data_MAUS/global_miningarea_30arcsecond_converted.h5"  # high res
