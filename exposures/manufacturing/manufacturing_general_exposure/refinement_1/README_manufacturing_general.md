...
- Manufacturing exposures per country based on sclaing with NOx emissions and production values: Largest contributors: China, USA, Japan, Germany, Korea, India, Brazil, Italy, France (Top List in agreement with Worlbank manufacuirng exports)
- The **final file** after step: **general_manufacture_values.h5**
