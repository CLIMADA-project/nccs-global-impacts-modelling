...
output_file = (
    "data/forest_exp_region_final_v3.h5"  # first output for region_id assignment
)
...
def get_country_vectorized_ISO_2(coordinates):
    ...
    for idx, country in tqdm(
        ...
        iso3_codes[lbls] = country[
            "ISO3"
        ]  # Assuming 'iso3' is the column with ISO3 codes in your _SHAPEFILE
...
df["value"] = (
    1  ## change value to just 1 # this is not necessary as the value changes to step 5
)
