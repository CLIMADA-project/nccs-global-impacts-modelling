...
from nccs.run_configurations.test.test_config import (
    CONFIG,
...
from nccs.utils.data_validation import validate_from_config
...
class TestAnalysisPipeline(unittest.TestCase):
    ...
    def test_data_validation(self):
        validation_df = validate_from_config(CONFIG)
